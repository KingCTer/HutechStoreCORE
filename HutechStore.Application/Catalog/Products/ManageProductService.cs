...
namespace HutechStore.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public ManageProductService(HutechStoreDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new HutechStoreException($"Cannot find a product: {productId}");
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new HutechStoreException($"Cannot find image with id {imageId}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new HutechStoreException($"Cannot find a product with id: {productId}");
